            ...
            <div class="col-md-3">
                ...
                <ul class="menu-list">
                    <?php if(!empty($footer[0]['contact_address'])){ ?>
                        <li><i class="fa fa-home" ></i><span>: Panjabari, Guwahati – 781037 </span></li>
                    <?php } ?>
                    <?php if(!empty($footer[0]['contact_phone'])){ ?>
                        <li><i class="fa fa-phone" ></i><span>: 0361-2332665</span></li>
                    <?php } ?>
                    <?php if(!empty($footer[0]['contact_email'])){ ?>
                        <li><i class="fa fa-envelope" ></i><span>: xyz@gmail.com</span></li>
                    <?php } ?>
                </ul>
            </div>
            <div class="col-md-12">
                <span>Copyright 2023 | Developed by <a href="" target="_blank">Chayandeep</a></span>
            </div>
        </div>
    </div>
</div>
